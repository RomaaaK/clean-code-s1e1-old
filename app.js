...
var createNewTaskElement=function(taskString){
    ...
    //label
    var nameTask=document.createElement("p");//label
    //input (text)
    ...
    nameTask.className='task__name';

    //Each elements, needs appending
    checkBox.type="checkbox";
    checkBox.className='input input_checkbox task__checkbox';
    editInput.type="text";
    editInput.className='input input_text task__change-name';
...
var editTask=function(){
    ...
    var editInput=listItem.querySelector('.task__change-name');
